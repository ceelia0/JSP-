...
<body>
	...
	<main>
		...
		<div class="row-container">
			...
			%>
			<div class="row">
				<span>姓名</span><span><%=a_info.getName()%></span>
			</div>
			<div class="row">
				<span>帐号</span><span><%=a_user.getAccount()%></span>
			</div>
			<div class="row">
				<span>年龄</span><span><%=a_info.getAge()%></span>
			</div>
			<div class="row">
				<span>身份</span><span><%=a_user.getRole()%></span>
			</div>
			<div class="row">
				<span>实际工资</span><span><%=a_income.getReal()%></span>
			</div>
		</div>
